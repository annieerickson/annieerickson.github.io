...
We know LLMs can infer characteristics of the user they are interacting with and change their behavior accordingly. To study this, I examined a dynamic user attribute, emotional state of the user, as a case study for how LLMs represent user features.  Through targeted interventions, I tested whether I could conditionally steer the appropriateness of the emotional response of the model to a user statement. 
...
<div class="caption">
    Subtracting or adding each steering class during an emotionally charged statement. Dark blue: very sad user statements, light blue: sad, pink: happy, and red: very happy.
</div>
